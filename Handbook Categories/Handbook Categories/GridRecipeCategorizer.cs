...
namespace Handbook_Categories
{
    public static class GridRecipeCategorizer
    {
        ...
        private static readonly Dictionary<string, string> ManualRecipeCategories = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            ["jonas/nightvisiondevice.json"] = "Machinery",
            ["jonas/resonator.json"] = "Machinery",
            ["jonas/returnbaserecipes.json"] = "Machinery",
            ["jonas/returndeath.json"] = "Machinery",
            ["jonas/riftward.json"] = "Machinery",
            ["ladder.json"] = "Construction",
            ["lantern.json"] = "Machinery",
            ...
            ["tobtranslocator.json"] = "Machinery",
            ...
            ["tool/solderingiron.json"] = "Machinery",
